    ...
    <div className={styles.page}>
      ...
      <div className={styles.infoGrid}>
        <div className={styles.infoCard}>
          ...
          <div className={styles.infoValue}>{format(new Date(field.planting_date), 'dd MMM yyyy')}</div>
        </div>
        <div className={styles.infoCard}>
          <div className={styles.infoLabel}>Days Since Planting</div>
          <div className={styles.infoValue}>{Math.floor((new Date() - new Date(field.planting_date)) / 86400000)}d</div>
        </div>
        <div className={styles.infoCard}>
          <div className={styles.infoLabel}>Last Updated</div>
          <div className={styles.infoValue}>{format(new Date(field.last_update), 'dd MMM yyyy')}</div>
        </div>
        <div className={styles.infoCard}>
